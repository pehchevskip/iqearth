...
import com.pehchevskip.iqearth.MainActivity;
...
public class GameServerService {
    ...
    private static final String NAME = "GameServer";
     ...
     */
    public GameServerService(Context context, Handler handler) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                GameServerService.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (GameServerService.this) {
                mConnectThread = null;
            }
